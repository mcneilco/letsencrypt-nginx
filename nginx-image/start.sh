...
sed -i "s/___LETSENCRYPT_IP___/$LETSENCRYPT_HOST/g" /etc/nginx/nginx.conf
...
echo replacing ___LETSENCRYPT_HTTPS_PORT___/$LETSENCRYPT_PORT
echo replacing ___APPLICATION_IP___/$ACAS_HOST
echo replacing ___APPLICATION_PORT___/$ACAS_PORT
...
sed -i "s/___LETSENCRYPT_PORT___/$LETSENCRYPT_PORT/g" /etc/nginx/nginx-secure.conf
sed -i "s/___LETSENCRYPT_HTTPS_IP___/$LETSENCRYPT_HOST/g" /etc/nginx/nginx-secure.conf
sed -i "s/___LETSENCRYPT_HTTPS_PORT___/$LETSENCRYPT_PORT/g" /etc/nginx/nginx-secure.conf

# Add your app's container IP and port into config
sed -i "s/___APPLICATION_IP___/$ACAS_HOST/g" /etc/nginx/nginx-secure.conf
sed -i "s/___APPLICATION_PORT___/$ACAS_PORT/g" /etc/nginx/nginx-secure.conf
